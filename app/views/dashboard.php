...
<head>
  ...
  <link rel="stylesheet" href="/assets/signalops.css?v=20260620">
  <script src="/assets/signalops-map.js?v=20260620" defer></script>
</head>
  ...
  <section class="dashboard-shell">
    <article class="panel hero-card">
      <div>
        ...
        <h2>Signal Ops Console</h2>
        <p>A compact status surface for Discord bots, trading or market-data APIs, archival databases, and the private machines behind them.</p>
      </div>
    ...
    <section class="lower-grid">
      ...
      <article class="panel mesh-panel" id="latency-map">
        <div class="section-head">
          <h2>Latency Mesh</h2>
          <span class="badge blue">Point to point</span>
        </div>
